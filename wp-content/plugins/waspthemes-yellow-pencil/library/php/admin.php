...
function yp_option_func() {
		...
		if(isset($_POST['yp_reset'])){
			?>
				<div id="message" class="updated">
			        <p><strong>Defined Labels and plugin options have been reset.</strong></p>
			    </div>
			<?php
		}
					...
					<form method="POST">
						...
						<table class="form-table yp-form-table">
							...
							<tr>
								...
								<td><code>doesn't add the changes to website.</code></td>
							</tr>
							</tbody>
						</table>
						...
						<div class="yp-output-css-footer">
							...
							<a class="button yp-button-reset">Reset</a>
						</div>
					</form>

	...
	*{
	...
	<script>
		...
		function typeListSelect(element){
			...
			if(id == 'search' || id == 'tag' || id == 'category' || id == 'archive' || id == 'author' || id == '404' || id == '0' || id == "login" || id == "register" || id == "lostpassword"){
			...
			if(id == "login" || id == "register" || id == "lostpassword"){
				...
				// Disable others and enable template
				...
				document.querySelectorAll(".customize-type-radio.type-center")[0].classList.add("active");
		...
		<div class="customize-type-page-section">
			...
			<div class="customize-type-select-list">
				<ul>
					...
					<li onclick="typeListSelect(this)" data-id-value="login" <?php echo $hasLogin; ?> data-type-value="login" data-type-href="<?php echo yp_urlencode(wp_login_url()); ?>"><i onclick="seePageLink(this)"></i><span>Login page</span></li>
					<?php
						$registerEnable = get_option("users_can_register");
						if($registerEnable){ ?>
						<li onclick="typeListSelect(this)" data-id-value="register" <?php echo $hasRegister; ?> data-type-value="register" data-type-href="<?php echo yp_urlencode(wp_registration_url()); ?>"><i onclick="seePageLink(this)"></i><span>Register page</span></li>
					<?php } ?>
					<li onclick="typeListSelect(this)" data-id-value="lostpassword" <?php echo $hasLostPass; ?> data-type-value="lostpassword" data-type-href="<?php echo yp_urlencode(wp_lostpassword_url()); ?>"><i onclick="seePageLink(this)"></i><span>Lost Password page</span></li>
